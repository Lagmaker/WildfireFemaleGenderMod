...
public class PlayerConfig extends EntityConfig {
	...
	public PlayerConfig(UUID uuid, Gender gender) {
		...
		this.cfg.setDefault(Configuration.BREASTS_WIDTH);
		this.cfg.setDefault(Configuration.BREASTS_HEIGHT);
		this.cfg.setDefault(Configuration.BREASTS_PROJECTION);
		this.cfg.setDefault(Configuration.BREASTS_BALANCE);
		this.cfg.setDefault(Configuration.BREASTS_SHAPE);
		this.cfg.setDefault(Configuration.BREASTS_NIPPLES);
		this.cfg.setDefault(Configuration.BREASTS_NIPPLE_SIZE);
		...
		this.cfg.setDefault(Configuration.WOBBLE_ENABLED);
		this.cfg.setDefault(Configuration.WOBBLE_INTENSITY);
		this.cfg.setDefault(Configuration.WOBBLE_SPEED);
		this.cfg.finish();
	}
	...
	public boolean updateWobble(boolean value) {
		return updateValue(Configuration.WOBBLE_ENABLED, value, v -> this.wobbleEnabled = v);
	}
	...
	public static JsonObject toJsonObject(PlayerConfig plr) {
		...
		Configuration.WOBBLE_ENABLED.save(obj, plr.hasWobble());
		Configuration.WOBBLE_INTENSITY.save(obj, plr.getWobbleIntensity());
		Configuration.WOBBLE_SPEED.save(obj, plr.getWobbleSpeed());
		...
		Configuration.BREASTS_WIDTH.save(obj, breasts.getWidth());
		Configuration.BREASTS_HEIGHT.save(obj, breasts.getHeight());
		Configuration.BREASTS_PROJECTION.save(obj, breasts.getProjection());
		Configuration.BREASTS_BALANCE.save(obj, breasts.getBalance());
		Configuration.BREASTS_SHAPE.save(obj, breasts.getShape());
		Configuration.BREASTS_NIPPLES.save(obj, breasts.hasNipples());
		Configuration.BREASTS_NIPPLE_SIZE.save(obj, breasts.getNippleSize());
		return obj;
	}
	...
	public static PlayerConfig loadCachedPlayer(UUID uuid, boolean markForSync) {
		...
		if (plr != null) {
			...
			plr.updateWobble(config.get(Configuration.WOBBLE_ENABLED));
			plr.updateWobbleIntensity(config.get(Configuration.WOBBLE_INTENSITY));
			plr.updateWobbleSpeed(config.get(Configuration.WOBBLE_SPEED));
			...
			breasts.updateWidth(config.get(Configuration.BREASTS_WIDTH));
			breasts.updateHeight(config.get(Configuration.BREASTS_HEIGHT));
			breasts.updateProjection(config.get(Configuration.BREASTS_PROJECTION));
			breasts.updateBalance(config.get(Configuration.BREASTS_BALANCE));
			breasts.updateShape(config.get(Configuration.BREASTS_SHAPE));
			breasts.updateNipples(config.get(Configuration.BREASTS_NIPPLES));
			breasts.updateNippleSize(config.get(Configuration.BREASTS_NIPPLE_SIZE));
			if (markForSync) {
				plr.needsSync = true;
			}
			return plr;
	...
	public static void saveGenderInfo(PlayerConfig plr) {
		...
		config.set(Configuration.WOBBLE_ENABLED, plr.hasWobble());
		config.set(Configuration.WOBBLE_INTENSITY, plr.getWobbleIntensity());
		config.set(Configuration.WOBBLE_SPEED, plr.getWobbleSpeed());
		...
		config.set(Configuration.BREASTS_WIDTH, plr.getBreasts().getWidth());
		config.set(Configuration.BREASTS_HEIGHT, plr.getBreasts().getHeight());
		config.set(Configuration.BREASTS_PROJECTION, plr.getBreasts().getProjection());
		config.set(Configuration.BREASTS_BALANCE, plr.getBreasts().getBalance());
		config.set(Configuration.BREASTS_SHAPE, plr.getBreasts().getShape());
		config.set(Configuration.BREASTS_NIPPLES, plr.getBreasts().hasNipples());
		config.set(Configuration.BREASTS_NIPPLE_SIZE, plr.getBreasts().getNippleSize());
