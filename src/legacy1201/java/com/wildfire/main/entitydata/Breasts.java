...
public class Breasts {
    ...
    public boolean updateWidth(float value) { return updateValue(Configuration.BREASTS_WIDTH, value, v -> width = v); }
    public float getHeight() { return height; }
    public boolean updateHeight(float value) { return updateValue(Configuration.BREASTS_HEIGHT, value, v -> height = v); }
    public float getProjection() { return projection; }
    public boolean updateProjection(float value) { return updateValue(Configuration.BREASTS_PROJECTION, value, v -> projection = v); }
    public float getBalance() { return balance; }
    public boolean updateBalance(float value) { return updateValue(Configuration.BREASTS_BALANCE, value, v -> balance = v); }
    public BreastShape getShape() { return shape; }
    public boolean updateShape(BreastShape value) { return updateValue(Configuration.BREASTS_SHAPE, value, v -> shape = v); }
    public boolean hasNipples() { return nipples; }
    public boolean updateNipples(boolean value) { return updateValue(Configuration.BREASTS_NIPPLES, value, v -> nipples = v); }
    public float getNippleSize() { return nippleSize; }
    public boolean updateNippleSize(float value) { return updateValue(Configuration.BREASTS_NIPPLE_SIZE, value, v -> nippleSize = v); }
